...
A privacy-first web app that looks at your texting and phone-call history with
friends and family and tells you whether each relationship is **trending up or
down**. Everything runs locally in your browser — no account, no server, no
...
- iMessage import (from a Mac's `chat.db` export)
